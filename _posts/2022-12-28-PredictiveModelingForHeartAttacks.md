...
This project intends to explore various models that can predict if a person is prone to a heart attack or not. This project was a collaborative effort with Andrea Lin, Joan Akibode, Sanaa Mouzahir, and Minh Nguyen. It served as a final project for the class "Data Science in Mechanical Systems" at Columbia University. See the code to the project [here](https://github.com/gloriahwoang/Predictive-Modeling-for-Heart-Attacks).
